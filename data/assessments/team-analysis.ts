...
export const teamAssessments = {
    ...
    talents: [
      {
        ...
        keyWords: ['appreciative', 'open-minded', 'considerate', 'attentive', 'approachable'],
        quadrant: 'Friend',
      },
      {
        score: 16,
        title: 'Caregiver',
        description: 'Focuses on emotions and feelings, aware of feelings in self and others.',
        keyWords: ['compassionate', 'nurturing', 'giving', 'genuine', 'selfless', 'thoughtful'],
        quadrant: 'Friend',
      },
      {
        score: 16,
        ...
        keyWords: ['supportive', 'respectful', 'cooperative', 'diplomatic', 'accepting'],
        quadrant: 'Friend',
      },
    ],
    personalityScore: {
      score: 62,
      quadrant: 'Friend',
      description: 'Emotional decision-maker and supporting relationship-oriented type',
    },
  ...
  'Michael Mataluni': {
    ...
    talents: [
      {
        score: 20,
        title: 'Winner',
        description: 'Likes to win, achieve and be noticed. Takes pride in achievements.',
        keyWords: ['competitive', 'ambitious', 'persuasive', 'persistent', 'opportunistic'],
        quadrant: 'Emcee',
      },
      {
        score: 18,
        ...
        keyWords: ['popular', 'charismatic', 'energetic', 'dynamic', 'influential'],
        quadrant: 'Emcee',
      },
      {
        score: 18,
    ...
    personalityScore: {
      score: 68,
      quadrant: 'Emcee',
      description: 'Dominant emotional decision-maker with independent approach',
    },
    ...
    talents: [
      {
        score: 19,
        title: 'Peacemaker',
        description: 'Gets along with and supports others. Appreciates feelings and emotions.',
        keyWords: ['appreciative', 'open-minded', 'considerate', 'attentive', 'approachable'],
        quadrant: 'Friend',
      },
      {
...
export const analyzeTeamDynamics = () => {
  const quadrantDistribution = Object.values(teamAssessments).reduce(
    (acc, assessment) => {
      acc[assessment.primaryQuadrant] = (acc[assessment.primaryQuadrant] || 0) + 1
      return acc
    },
