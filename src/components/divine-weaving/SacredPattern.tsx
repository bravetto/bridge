...
const sacredNodes: SacredNode[] = [
  {
    ...
    connections: ["michael-mataluni", "martha-henderson"],
  },
  {
    id: "jahmere-webb",
    name: "JAHmere Webb",
    ...
    connections: ["michael-mataluni", "jay-forte", "jordan-dungy"],
  },
  {
    id: "jay-forte",
    name: "Jay Forte",
    ...
    essence: "Sacred Play",
    connections: ["martha-henderson", "bill-mcdade", "jacob", "paul"],
  },
  {
    id: "martha-henderson",
    ...
    connections: ["jay-forte", "jordan-dungy"],
  },
];
