...
> **CORNERSTONE REFERENCE**: All AI guidance must first consult the [AI Architecture Cornerstone 2025](./00-AI-ARCHITECTURE-CORNERSTONE-2025.md) for critical patterns and performance targets.
